...
def stFeatureExtraction(signal, Fs, Win, Step):
    ...
    curPos = 0
    countFrames = 0
    nFFT = int(Win / 2) #TODO careful
    conversion_diff =  (Win / 2) - nFFT
    if conversion_diff != 0:
        print("WARNING: int 2 float conversion causes value difference%f"%conversion_diff)
